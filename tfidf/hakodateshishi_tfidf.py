...
cursor.execute("TRUNCATE TABLE hakodateshishi_tfidf")
connector.commit()

sql = "select paragraph_title,paragraph_body, id from hakodateshishi_removecite;"
cursor.execute(sql)
...
# 出力
f = open("tfidf_hakodateshishi.txt", "w")
i = 0
for fv,record in zip(fv_tf_idf,records):
    ...
    cursor.execute('INSERT INTO hakodateshishi_tfidf (hakodateshishi_id, tfidf1, tfidf2, tfidf3, tfidf4, tfidf5)\
